...
# Key pericopes for direction scoring validation (Goodacre's fatigue examples)
# These are referenced directly by the evaluation pipeline.
GOODACRE_FATIGUE_PERICOPES: Final[dict[str, dict[str, str]]] = {
    # Triple tradition (Mark → Matthew/Luke fatigue)
    "death_of_john": {
        "matthew": "Matt 14:1-12",
        "mark": "Mark 6:14-29",
        "pericope_id": None,  # Not in our 3-gospel table; covered within passion block
    },
    "cleansing_leper": {
        "matthew": "Matt 8:1-4",
        "mark": "Mark 1:40-45",
    ...
    # Double tradition (Luke fatiguing with Matthew as source — Farrer hypothesis)
    "centurion_servant": {
        "matthew": "Matt 8:5-13",
        "luke": "Luke 7:1-10",
        "pericope_id": "029",
    },
    "parable_pounds_talents": {
        "matthew": "Matt 25:14-30",
        "luke": "Luke 19:11-27",
        "pericope_id": "147",
    },
    "mission_charge": {
        "matthew": "Matt 10:5-15",
        "luke": "Luke 9:1-6",
        "pericope_id": "057",
    },
}

# Minor agreements — passages where Matthew and Luke agree against Mark.
# Anti-2SH evidence; key test cases for the direction scorer.
MINOR_AGREEMENTS: Final[list[dict[str, str]]] = [
    {
        "name": "Mocking of Jesus",
        "matthew": "Matt 26:67-68",
        "mark": "Mark 14:65",
        "luke": "Luke 22:64",
        "pericope_id": "183",
    },

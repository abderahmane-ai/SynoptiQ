...
Evaluates frozen encoder representations by training a lightweight
linear probe on top of per-token hidden states and measuring POS
tagging accuracy on held-out data.
"""
